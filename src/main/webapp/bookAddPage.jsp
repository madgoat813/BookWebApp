<%-- 
    ...
    Created on : May 2, 2016, 12:00:16 AM
    Author     : Taylor
--%>
    ...
    <body>
        <form method="POST" action="BookController" class="col-md-4">
            ...
            <table class="table">
                ...
                <thead><td>Book Isbn</td></thead>
                <td><input type="text" name="isbn" value="${book.isbn}" class="form-control" placeholder="Enter Isbn Here"/></td>
                </tr>
                <thead><td>Author Id</td></thead>
                <td><input type="text" name="authorId" value="${book.authorId}" class="form-control" placeholder="Enter Id Here"/></td>
                </tr>
                <tr>
